...
func Goroutine1() {
	...
	*/
	...
	// res2 := <- ch3 // just waits for the first thread to return a value in the channel | the other goroutines will still complete but the program will not wait on this step to catch their returned values
	// fmt.Println("res2 value:", res2) // -> res2 value: 8
